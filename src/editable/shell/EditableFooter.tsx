          ...
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr_0.85fr]">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link href="/search" className="rounded-full bg-[var(--slot4-accent-bright)] px-5 py-3 text-xs font-black uppercase tracking-[0.16em] text-[var(--slot4-page-text)]">
                  Explore ideas
                </Link>
                <Link href="/about" className="rounded-full border border-white/15 px-5 py-3 text-xs font-black uppercase tracking-[0.16em] text-white">
                  About us
                </Link>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-[11px] font-black uppercase tracking-[0.28em] text-white/45">Explore</h3>
              <div className="mt-5 grid gap-3">
                {exploreLinks.map((item) => (
                  <Link key={item.href} href={item.href} className="inline-flex items-center gap-2 text-sm font-bold text-white/78 hover:text-white">
